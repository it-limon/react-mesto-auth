  ...
  return (
    <>
      ...
      <section className='login'>
        <form className='form form_theme_dark' name='form-login' onSubmit={handleSubmit}>
          ...
          <button className='form__button-submit form__button-submit_theme_dark' type='submit'>Войти</button>
        </form>
      </section>
    </>
  );
